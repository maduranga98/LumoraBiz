...
export const ManagerAddingPaddy = () => {
  ...
  const fetchBuyers = async () => {
    ...
    setLoading(true);
    try {
      const buyersCollectionPath = `owners/${currentUser.ownerId}/businesses/${currentBusiness.id}/buyers`;
  ...
  const fetchPaddyTypes = async () => {
    ...
    try {
      const paddyTypesCollectionPath = `owners/${currentUser.ownerId}/businesses/${currentBusiness.id}/productsTypes`;
  ...
  const checkCodeExistsInDB = async (code) => {
    ...
    try {
      const paddyTypeDocPath = `owners/${currentUser.ownerId}/businesses/${currentBusiness.id}/productsTypes/${code}`;
  ...
  const handleAddPaddyType = async (e) => {
    ...
    try {
      ...
      const paddyTypeDocPath = `owners/${currentUser.ownerId}/businesses/${currentBusiness.id}/productsTypes/${finalCode}`;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const purchaseCollectionPath = `owners/${currentUser.ownerId}/businesses/${currentBusiness.id}/buyers/${formData.buyerId}/purchases`;
      ...
      const stockCollectionPath = `owners/${currentUser.ownerId}/businesses/${currentBusiness.id}/stock/rawProcessedStock/stock`;
      ...
      const purchaseDocPath = `owners/${currentUser.ownerId}/businesses/${currentBusiness.id}/buyers/${formData.buyerId}/purchases/${purchaseId}`;
  ...
  const handlePaymentComplete = async (paymentData) => {
    try {
      const paymentsCollectionPath = `owners/${currentUser.ownerId}/businesses/${currentBusiness.id}/payments`;
...
export default ManagerAddingPaddy;

...
const ManagerLogisticsExpensesList = () => {
  ...
  useEffect(() => {
    const fetchExpenses = async () => {
      ...
      try {
        ...
        const expensesCollectionPath = `owners/${currentUser.ownerId}/businesses/${currentBusiness.id}/vehicleExpenses`;
        const vehiclesCollectionPath = `owners/${currentUser.ownerId}/businesses/${currentBusiness.id}/vehicles`;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
          <h3 className="text-xs font-medium text-gray-500 uppercase">Fuel</h3>
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
          ...
          <p className="text-xs text-gray-500 mt-1">
            {summary.totalExpenses
              ? Math.round(
                  ((summary.taxExpenses + summary.otherExpenses) /
                    summary.totalExpenses) *
                    100
                )
              : 0}
...
export default ManagerLogisticsExpensesList;

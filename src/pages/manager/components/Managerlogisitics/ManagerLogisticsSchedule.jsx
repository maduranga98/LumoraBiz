  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const servicesCollectionPath = `owners/${currentUser.ownerId}/businesses/${currentBusiness.id}/vehicleServices`;
  ...
  const filteredTasks = maintenanceTasks.filter((task) => {
    ...
    if (filters.dateRange !== "all") {
      ...
      if (filters.dateRange === "next30days") {
        ...
        return (
          isBefore(task.scheduledDateObj, today) &&
          !isToday(task.scheduledDateObj)
        );
      }
    }
  ...
  const handleAddTask = async (e) => {
    ...
    try {
      ...
      const taskData = {
        ...
        description:
          newTask.description || getServiceTypeLabel(newTask.serviceType),
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="tire_replacement">Tire Replacement</option>
                      <option value="engine_service">Engine Service</option>
                      <option value="electrical_service">
                        Electrical Service
                      </option>
                      <option value="other">Other</option>
                    </select>
